# codigo para extracao de angulos a partir de arquivos do tipo .json armazenados pelo openpose
# ------------------------------------------------------------------------------------
# bibliotecas
import os, json
import math
...
def get_angle(superior, central, inferior, qual_parte):
    if superior[0] == 0 or superior[1] == 0 or central[0] == 0 or central[1] == 0 or inferior[0] == 0 or inferior[
        1] == 0:
        angulo = 0
    else:
        v1 = superior - central
