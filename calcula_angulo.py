...
def plot(data,string,n):
	...
	plt.show()
#------------------------------------------------------------------------------------
#leitura dos arquivos .json na pasta criada pelo programa indicada pelo usuario
...
#calculam-se os angulos
	...
	#rha = 180 - get_angle(trunk,right_hip,right_knee)
	#right_hip_angle.insert(index,rha)

	#raa =  90 - get_angle(right_knee,right_ankle,right_line)
...
#segmenta(right_knee_angle,rightciclos,'medknee_angle.npy')
#plot(right_knee_angle,"angulo do joelho direito",3)

#segmenta(right_hip_angle,rightciclos,'medhip_angle.npy')
#plot(right_hip_angle,"angulo do quadril direito",4)

#segmenta(right_ankle_angle,rightciclos,'medankle_angle.npy')
